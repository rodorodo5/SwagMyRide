app.controller('homeController', function($scope, user, $http,$location,dataFactory,$routeParams ,$window,anchorSmoothScroll,$sce) {
    //Panel controller, requests and front-end logic
    var URL = "http://localhost.com/myride";
