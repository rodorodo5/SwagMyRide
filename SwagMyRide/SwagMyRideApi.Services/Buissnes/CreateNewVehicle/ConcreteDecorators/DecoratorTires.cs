...
{
    public class DecoratorTires:Components
    {
        private readonly SwagMyRide.Data.Models.Vehicles.Vehicle _vehicle;
        private readonly string _description;
        public DecoratorTires(SwagMyRide.Data.Models.Vehicles.Vehicle vehicle)
        {
            this._vehicle = vehicle;
            this._description = vehicle.TiresCatalogue.Description;
